...
<div class="bg0 m-t-23 p-b-140">
    <div class="container">
                        ...
                        <div class="block2-txt-child2 flex-r p-t-3">
                            <a href="<?= base_Url().'/tienda/producto/'.$arrProductos[$p]['nombre']?>"
                                ...
                                <img class="icon-heart1 dis-block trans-04"
                                    src="<?= media()?>/tienda/images/icons/icon-heart-01.png" alt="ICON">
        ...
        <div class="flex-c-m flex-w w-full p-t-45">
            ...
            <a href="<?= base_url() ?>/tienda/categoria/<?= $data['infoCategoria']['idcategiria'].'/'.$data['infoCategoria']['ruta'].'/'.$prevPagina ?>"
            ...
            <a href="<?= base_url() ?>/tienda/categoria/<?= $data['infoCategoria']['idcategiria'].'/'.$data['infoCategoria']['ruta'].'/'.$nextPagina ?>"
