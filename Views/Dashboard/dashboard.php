...
<body class="app sidebar-mini">
                    ...
                    <div class="app-notification__content">
                        ...
                        <li><a class="app-notification__item" href="javascript:;"><span
                                ...
                                <div>
                                    ...
                                    <p class="app-notification__meta"><?php echo $data['page_title'] ?></p>
                                </div>
                            </a></li>
                        <div class="app-notification__content">
                            <li><a class="app-notification__item" href="javascript:;"><span
    ...
    <aside class="app-sidebar">
        <div class="app-sidebar__user"><img class="app-sidebar__user-avatar"
                src="https://img2.freepng.es/20180331/khw/kisspng-computer-icons-user-clip-art-user-5abf13d4b67e20.4808850915224718927475.jpg" style="width:60px" alt="User Image">
            <div>
